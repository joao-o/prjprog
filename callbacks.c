  ...
  if(pdat->mouse.nestx > pdat->drawbox->allocation.width
  ...
  else if (pdat->mouse.trap != 0 && event->type == GDK_MOTION_NOTIFY)
    {
      switch (pdat->mouse.trap)
        {
          case 1:
            jerrylens(pdat,pdat->barl);break;
          case 2:
            jerrylens(pdat,pdat->barr);break;
          case 3:
            mickeyfocus(pdat,pdat->barfc);break;
          case 4:
            mickeyfocus(pdat,pdat->barfd);break;
  ...
  else if (event->type == GDK_BUTTON_PRESS)
    {
      if (((pdat->mouse.nestx - pdat->physdata.poslc) 
        ...
        {
          pdat->mouse.trap = 1;  
          pdat->mouse.path1 = pdat->physdat.poslc - pdat->mouse.nestx;
        }
        ...
        {
          pdat->mouse.trap = 2;
          pdat->mouse.path1 = pdat->physdata.posd - pdat->mouse.nestx;
        }
    }
